...
class Mult8x83stages extends Module {
  ...
  val mul2shift0 = RegInit(0.U(8.W))
  val mul2shift1 = RegInit(0.U(8.W))
  val mul2shift2 = RegInit(0.U(8.W))
  val mul2shift3 = RegInit(0.U(8.W))

  val shift2adder0 = RegInit(0.U(16.W))
  val shift2adder1 = RegInit(0.U(16.W))
  val shift2adder2 = RegInit(0.U(16.W))
  val shift2adder3 = RegInit(0.U(16.W))
  ...
  mul2shift0:=mymul0.io.result

  mul2shift1:=mymul1.io.result
  shifter0.io.input:=mul2shift1
  shifter0.io.cnt:=1.U(2.W)

  mul2shift2:=mymul2.io.result
  shifter1.io.input:=mul2shift2
  shifter1.io.cnt:=1.U(2.W)

  mul2shift3:=mymul3.io.result
  shifter2.io.input:=mul2shift3
  shifter2.io.cnt:=2.U(2.W)

  shift2adder0:=mul2shift0
  shift2adder1:=shifter0.io.result
  shift2adder2:=shifter1.io.result
  shift2adder3:=shifter2.io.result

  adder0.io.b:= shift2adder0
  adder0.io.a:= shift2adder1

  adder1.io.b:= shift2adder2
  adder1.io.a:= shift2adder3
